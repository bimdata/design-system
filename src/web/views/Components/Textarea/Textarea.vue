    ...
    return {
      ...
      propsData: [
        ...
        [
          ...
          "Boolean",
          "false",
          "Use this boolean to make textarea color green",
        ],
        [
          "successMessage",
          "String",
          "",
          "Use this props to add a success text",
        ],
        [
          "error",
          "Boolean",
          "false",
          "Use this boolean to make textarea color red",
        ],
        ["errorMessage", "String", "", "Use this props to add an error text"],
      ],
      eventsData: [
        ["Event name", "Payload"],
