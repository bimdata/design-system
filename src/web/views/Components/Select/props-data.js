...
export default [
  ...
  [
    ...
    "String",
    "default",
    "Set the selector color (e.g. 'default', 'primary', 'secondary', 'tertiary', 'tertiary-light', 'quaternary', 'white').",
  ],
  ...
  [
    ...
    "[String, Number]",
    "12px",
    "Set the font size of the selector.",
  ],
  ["height", "[String, Number]", "32px", "Set the selector height."],
  ...
  ["placeholder", "String", "null", "Set the selector placeholder."],
  [
    "resetOnLeave",
    "Boolean",
    "false",
    "In multi-selection mode: clear search bar on click away.",
  ],
  ...
  [
    ...
    "String",
    "primary",
    "Set the color of the search input. (e.g. 'primary', 'secondary', 'tertiary', 'quaternary', 'quaternary-light').",
  ],
  [
    "searchPlaceholder",
    "String",
  ...
  [
    ...
    "Boolean",
    "false",
    "When true, selected and hovered elements have rounded borders.",
  ],
];
