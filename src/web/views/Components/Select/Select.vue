    ...
    <div class="article-wrapper">
      ...
      <div class="m-t-12">
        ...
        <p>
          ...
          the option (or list of options) that are selected).
        </p>
        <p>
          Put another way, the <strong>optionKey</strong> prop allow you to
          control which option field is used to determine which options are
          selected but it does not affect the selector model value.
        </p>
      </div>
