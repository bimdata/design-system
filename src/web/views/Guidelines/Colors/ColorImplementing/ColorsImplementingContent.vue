<template>
  <div class="colors-implementing-container">
    ...
    <BIMDataTable
      class="m-b-24"
      :columns="primaryColorData[0]"
      :rows="primaryColorData.slice(1)"
    />
    ...
    <ColorSwatche :colors="quaternaryColors"></ColorSwatche>
    <BIMDataTable
      class="m-b-24"
      :columns="quaternaryColorData[0]"
      :rows="quaternaryColorData.slice(1)"
    />
    ...
    <BIMDataTable
      class="m-b-24"
      :columns="highColorData[0]"
      :rows="highColorData.slice(1)"
    />
    ...
    <BIMDataTable
      class="m-b-24"
      :columns="warningColorData[0]"
      :rows="warningColorData.slice(1)"
    />
...
import tertiaryColors from "../js/tertiaryColors.js";
  ...
  data() {
    return {
      ...
      primaryColorData: [
        ...
        [
          "Primary Lighter",
          "Used for hover primary outline & primary ghost buttons.",
        ],
        [
          "Primary Light",
          "Used fo hover fill primary button & active ripple primary buttons.",
        ],
        ["Primary Dark", "Not used yet."],
      ],
      secondaryColorData: [
        ["Colors", "Description"],
        ["Secondary", ""],
        [
          "Secondary Lighter",
          "Used for background hover secondary outline & secondary ghost buttons.",
        ],
        [
          "Secondary Light",
      ...
      quaternaryColorData: [
        ...
        [
          "Quaternary Lighter",
          "Used for background hover quaternary outline & quaternary ghost buttons.",
        ],
        [
          "Quaternary Light",
          "Used fo hover fill quaternary button & active ripple quaternary buttons.",
        ],
        ["Quaternary Dark", "Not used yet."],
      ],
      highColorData: [
        ["Colors", "Description"],
        ["High", ""],
        ...
        [
          "High Light",
          "Used for background-color hover state for high fill & background-color active state ripple button.",
        ],
        ["High Dark", "Not used yet."],
      ],
      warningColorData: [
        ["Colors", "Description"],
        ["Warning", ""],
