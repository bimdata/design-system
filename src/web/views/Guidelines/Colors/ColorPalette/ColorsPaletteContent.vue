<template>
  <div class="colors-container">
    ...
    <ColorPalette :colors="allBrandColors"></ColorPalette>
    <BIMDataTable
      class="m-t-24"
      :columns="tableData[0]"
...
import ColorPalette from "../GenericComponents/ColorPalette.vue";
  ...
  data() {
    return {
      ...
      tableData: [
        ...
        ["Black", "--color-black", "rgb(0,0,0)", "This is black color !"],
        [
          "High",
          "--color-high",
          "rgb(255, 61, 30)",
