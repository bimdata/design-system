...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    },
    {
      ...
      description:
        "Get component source as full/template/script/style",
      inputSchema: {
        type: "object",
        properties: {
          name: {
    ...
    {
      name: "list_icons",
      description: "List icon metadata from library and standalone icon sources",
      inputSchema: {
        type: "object",
        properties: {},
      },
    ...
    {
      name: "search_icons",
      description: "Search icons by name, file, or path, optionally filtered by type",
      inputSchema: {
        type: "object",
        properties: {
          query: {
    ...
    },
    {
      ...
      description: "Get exact icon entries by icon name, optionally filtered by type",
      inputSchema: {
        type: "object",
        properties: {
          name: {
    ...
    },
    {
      ...
      description: "Rebuild components, tokens, css classes, and icon metadata",
      inputSchema: {
        type: "object",
        properties: {},
      },
